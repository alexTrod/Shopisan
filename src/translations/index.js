export default {    
    en: {
        ...
        merchant_registration_complete: 'Your account and store have been registered!',
        store_pending_approval: 'Your store is pending admin approval',
        registration_failed: 'Registration failed. Please try again.',
        user_data_missing: 'User data is missing. Please go back and fill in your details.',
        ...
        email_change_info: 'If you change your email, you will receive a verification link at the new address.',
        ...
        check_inbox_instruction: 'Please check your inbox and follow the instructions to reset your password.',
        ...
        delete_store_confirm: 'Are you sure you want to delete this store? This action is irreversible.',
        ...
        all_fields_required: 'All fields are required, including at least one category!',
    ...
    fr: {
        ...
        merchant_registration_complete: 'Votre compte et votre boutique ont été enregistrés !',
        ...
        user_data_missing: 'Les données utilisateur sont manquantes. Veuillez revenir en arrière et remplir vos informations.',
        categories_selected: 'catégorie(s) sélectionnée(s)',
        close: 'Fermer',
        email_already_in_use: 'Cette adresse email est déjà utilisée.',
        error_checking_email: 'Erreur lors de la vérification de l\'email. Veuillez réessayer.',
        ...
        email_change_info: 'Si vous changez votre email, vous recevrez un lien de vérification à la nouvelle adresse.',
        ...
        check_inbox_instruction: 'Veuillez vérifier votre boîte de réception et suivre les instructions pour réinitialiser votre mot de passe.',
        check_inbox_code: 'Vérifiez votre boîte de réception pour le code à 6 chiffres.',
        done: 'Terminé',
        ...
        delete_store_confirm: 'Êtes-vous sûr de vouloir supprimer ce magasin ? Cette action est irréversible.',
        ...
        all_fields_required: 'Tous les champs sont obligatoires, ainsi qu\'une catégorie !',
        address_not_found: 'Impossible de trouver l\'adresse. Vérifiez les informations.',
