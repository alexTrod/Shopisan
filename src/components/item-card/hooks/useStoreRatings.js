      ...
      try {
        ...
        if (userRatingSnapshot.empty) {
          await addDoc(ratingsRef, {
            store_id: storeId,
            // Must be user_id: the dedupe query above and firestore.rules both
            // key off it. This previously wrote user_profile_id, so the query
            // never matched and each rating created a duplicate document.
